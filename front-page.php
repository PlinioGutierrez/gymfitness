...
<section class="areas">
    <div class="area">
        ...
        ?>
        <img src="<?php echo esc_attr($area1['imagen']['sizes']['medium_large']) ?>" alt="Imagen <?php echo esc_attr($area1['texto']); ?>">
    ...
    <div class="area">
        ...
        ?>
        <img src="<?php echo esc_attr($area2['imagen']['sizes']['medium_large']) ?>" alt="Imagen <?php echo esc_attr($area2['texto']); ?>">
    ...
    <div class="area">
        ...
        ?>
        <img src="<?php echo esc_attr($area3['imagen']['sizes']['medium_large']) ?>" alt="Imagen <?php echo esc_attr($area3['texto']); ?>">
    ...
    <div class="area">
        ...
        ?>
        <img src="<?php echo esc_attr($area4['imagen']['sizes']['medium_large']) ?>" alt="Imagen <?php echo esc_attr($area4['texto']); ?>">
...
<main class="contenedor seccion">
    ...
    <div class="contenedor-boton">
        <a href="<?php echo esc_url(get_permalink(get_page_by_title('Clases'))) ?>" class="boton boton-primario">
